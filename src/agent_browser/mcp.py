...
class BrowserServer:
    ...
    def __init__(self, name: str) -> None:
        ...
        # Video/TTS state (Cinematic Engine - lazy-loaded)
    ...
    def _register_tools(self) -> None:
        ...
        # Cinematic Engine - Video production tools (Phase 1: Voice & Timing)
        self.server.tool()(self.generate_voiceover)
        self.server.tool()(self.get_audio_duration)
...
4. For SPAs, use wait_for_change() after clicking to detect updates"""
    ...
    # =========================================================================
    # Cinematic Engine - Phase 1: Voice & Timing
    # =========================================================================
